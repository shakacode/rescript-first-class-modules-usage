...
@val @scope("Promise")
external seven: ((t<'a0>, t<'a1>, t<'a2>, t<'a3>, t<'a4>, t<'a5>, t<'a6>)) => t<(
  'a0,
  'a1,
  'a2,
  'a3,
...
let tap = (x: t<'a>, fn: 'a => 'b): t<'a> => x->andThen(x => {
    x->fn
    x->resolve
  })
...
let mapOk = (x: result<'ok, 'error>, fn: 'ok => 'ok'): result<'ok', 'error> => x->andThen(x =>
    switch x {
